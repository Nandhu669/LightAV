...
def run_server():
    ...
    import uvicorn
    uvicorn.run("services.server:app", host="127.0.0.1", port=8000, log_level="error")
...
class LightAVWindow(QMainWindow):
    def __init__(self):
        ...
        from system.usb_monitor import monitor_usb
    ...
    def handle_usb_detected(self, drive):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            from system.usb_monitor import scan_usb
