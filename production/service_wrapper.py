...
from production.agent.resource_scanner import ResourceAwareScanner
from production.agent.self_protection import SelfProtection
from agent.file_monitor import start_monitor, Observer
